...
if input("Do you want to use a saved machine?[y/n]").lower()=="y":
    ...
    new_name=input("Put a name to your new ENIGMA machine so it is easier to ID afterwards. \nDo NOT put a overly revealing name related to your communications.")
    ...
    if input("Do you want to do an adjustment on the randomly generated machine?[y/n]:")=="y":
